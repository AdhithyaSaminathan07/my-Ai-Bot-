...
// // 1. Load your passwords from the .env.local file
// dotenv.config({ path: '.env.local' });

// const MONGODB_URI = process.env.MONGODB_URI;
// const GOOGLE_API_KEY = process.env.GOOGLE_GENERATIVE_AI_API_KEY;

// // 2. Your Resume Data (This is what we will send to Compass)
// const myData = [
//   "My name is Adhithya. I am a Junior MERN Stack Developer.",
//   "I built an 'Internship Admission System' using Node.js, Express, and MongoDB with WhatsApp integration.",
//   "I developed a 'Mobile Billing Application' for 'Vaseegrah Veda' using NFC and React.",
//   "I am proficient in MongoDB, Express, React, Node.js (MERN Stack) and Next.js.",
//   "I have deployed apps on AWS EC2 and Vercel."
// ];
...
//   // 4. Generate 'Brain Waves' (Embeddings) for your data
...
//   console.log("✅ Success! Check Compass now.");
//   await client.close();
// }
